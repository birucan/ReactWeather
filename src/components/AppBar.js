...
import { AppBar, Toolbar, Drawer, Button, List, ListItem, ListItemIcon, ListItemText, Typography, IconButton  } from '@material-ui/core';

//assets
import MenuIcon from '@material-ui/icons/Menu';
import GitHubIcon from '@material-ui/icons/GitHub';
import licenses from './../img/svg/contract.svg'
...
function AppBarUI(props){
    ...
    const buttonList = () => (
        <List>
            <ListItem button onClick={()=>{pageHandler('weather')}}>                         
                <ListItemText>Weather</ListItemText>
                <ListItemIcon><WbSunnyIcon/></ListItemIcon>
            </ListItem>

            <ListItem button onClick={()=>{pageHandler("licenses")}}>                     
                <ListItemText>Licenses</ListItemText>
                <ListItemIcon><DescriptionIcon/></ListItemIcon>
            </ListItem>
            
            <a href="https://github.com/birucan/ReactWeather" style={{ textDecoration: 'none', color: 'black'}}>
            <ListItem button>              
    ...
    return(
        ...
        <div className="AppBarContainer" pageState={props.pageState} setPageState={pageHandler}>
